...
{
    class VerifyError : Selenium_Base
    {
        public void InvalidEmail(IWebDriver Driver)
        {
            ...
            sendKeys(FindXPath("//input[@id='email_create']"), "laxmi123.com");
            wait(3000);
        ...
        public void MandatoryFields(IWebDriver Driver)
        {
            open("http://automationpractice.com/index.php");
            wait(500);
            ...
            sendKeys(FindXPath("//input[@id='email_create']"), "laxmigorai31@gmail.com");
            wait(3000);
        ...
        public void InvalidValue(IWebDriver Driver)
        {
            open("http://automationpractice.com/index.php");
            wait(500);
            ...
            sendKeys(FindXPath("//input[@id='postcode']"), "562405");
            wait(2000);
            ...
            sendKeys(FindXPath("//input[@id='phone']"), "asfghghkh");
            wait(2000);

            sendKeys(FindXPath("//input[@id='phone_mobile']"), "9046773962");
            wait(2000);

            sendKeys(FindXPath("//input[@id='alias']"), "Benachity");
            wait(2000);
